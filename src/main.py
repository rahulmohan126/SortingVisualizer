...
class Visualizer:
	...
	def refresh(self, pointer):
		...
		self.screen.blit(render_text(self.type.capitalize() + f' Sort | Sorting {self.arr_size} items.'), (10, 10))

		speed_text = render_text('Speed: ' + str(self.sort_speed))
	...
	def mainloop(self):
		...
		while True:
			...
			speed_text = render_text('Speed: ' + str(self.sort_speed))
			self.screen.blit(speed_text, (SCREEN_WIDTH - speed_text.get_width() - 10, 130))
